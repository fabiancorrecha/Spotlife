                                ...
                                child: Container(
                                  ...
                                  child: StreamBuilder<UserPostsRecord>(
                                    stream: UserPostsRecord.getDocument(
                                        editarPostUserPostsRecord.reference),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: List.generate(
                                                      ...
                                                      return InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDITAR_POST_Container_gos3ljn6_ON_TAP');
                                                          logFirebaseEvent(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Visibility(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'EDITAR_POST_PAGE_Image_ry5fppge_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Image_navigate_to');
                                                              ...
                                                              onLongPress:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'EDITAR_POST_Image_ry5fppge_ON_LONG_PRESS');
                                                                logFirebaseEvent(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: TextFormField(
                                            controller:
                                              ...
                                              text: editarPostUserPostsRecord
                                                  .postTitle,
                                            ),
                                            focusNode:
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'h5nste0h' /* Etiqueta la ubicación */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'wstfwl3i' /* Crear una nueva colección */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
