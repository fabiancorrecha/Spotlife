                              ...
                              child: StreamBuilder<List<CollectionsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CollectionsRecord>
                                      textFieldBuscarCollectionsRecordList =
                                      snapshot.data!;
                    ...
                    child: StreamBuilder<List<CollectionsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Container(
                          decoration: const BoxDecoration(),
                          child: Visibility(
                            visible: _model.textFieldBuscarTextController.text != '',
                            child: Builder(
                              builder: (context) {
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Visibility(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'OTRO_PERFIL_COLECCIONES_Stack_wcxxqrqw_O');
                                                          logFirebaseEvent(
                                                              'Stack_navigate_to');
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('OTRO_PERFIL_COLECCIONES_ellipsisV_ICN_ON');
