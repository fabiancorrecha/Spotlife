...
abstract class FlutterFlowTheme {
  ...
  late Color icono;
  late Color fondoIcono;
  late Color customSeleccion;
  late Color rojo;
  late Color btnText;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF4F176);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFA5A0EF);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFAF7FA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF4F176);
  late Color secondary = const Color(0xFF5AB791);
  late Color tertiary = const Color(0xFFA5A0EF);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFAF7FA);
  late Color secondaryText = const Color(0xFF95A1AC);
