...
class _MenuPostAjenoWidgetState extends State<MenuPostAjenoWidget>
  ...
  void initState() {
    ...
    animationsMap.addAll({
      ...
      'notificacionBoxOnActionTriggerAnimation': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          ...
          children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'MENU_POST_AJENO_Column_kwfjoq6l_ON_TAP');
                                      logFirebaseEvent('Column_bottom_sheet');
                                      Navigator.pop(context);
                                      logFirebaseEvent('Column_bottom_sheet');
                                      await showModalBottomSheet(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        FaIcon(
                                          ...
                                          color:
                                              FlutterFlowTheme.of(context).rojo,
                                          size: 24.0,
                                        ),
                                        Row(
                                          mainAxisSize: MainAxisSize.max,
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                animationsMap['notificacionBoxOnActionTriggerAnimation']!,
              ),
            ),
          ],
        );
