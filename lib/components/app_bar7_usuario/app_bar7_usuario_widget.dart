...
class AppBar7UsuarioWidget extends StatefulWidget {
  const AppBar7UsuarioWidget({
    super.key,
    this.usuario,
  });
  ...
  @override
  State<AppBar7UsuarioWidget> createState() => _AppBar7UsuarioWidgetState();
}

class _AppBar7UsuarioWidgetState extends State<AppBar7UsuarioWidget> {
  late AppBar7UsuarioModel _model;
  ...
  Widget build(BuildContext context) {
    return
        // Esta barra contiene detalles del usuario
