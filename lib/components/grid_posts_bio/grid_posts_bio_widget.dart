                          ...
                          return SizedBox(
                            ...
                            child: Stack(
                              children: [
                                  ...
                                  children: [
                                    if ((stackUserPostsRecord
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'GRID_POSTS_BIO_ContainerImage_ON_TAP');
                                          logFirebaseEvent(
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'GRID_POSTS_BIO_Image_312ehnwx_ON_TAP');
                                              logFirebaseEvent(
                                                  'Image_navigate_to');
                                            ...
                                            onLongPress: () async {
                                              logFirebaseEvent(
                                                  'GRID_POSTS_BIO_Image_312ehnwx_ON_LONG_PR');
                                              logFirebaseEvent(
                                ...
                                if (stackUserPostsRecord.postPhotolist.length >=
                                    2)
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(0.75, -0.83),
                                    child: Padding(
                                ...
                                Align(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'GRID_POSTS_BIO_keyboard_control_ICN_ON_T');
