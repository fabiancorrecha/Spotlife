...
import '/banner_de_alertas/alerta_eliminar_post/alerta_eliminar_post_widget.dart';
                ...
                child: Row(
                  ...
                  children: [
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'MENU_POST_PROPIO_COMP_close_ICN_ON_TAP');
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MENU_POST_PROPIO_Container_h3yhds4t_ON_T');
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      ...
                                      'esVideo': serializeParam(
                                        containerUserPostsRecord.esVideo,
                                        ParamType.bool,
                                      ),
                                    }.withoutNulls,
                            ...
                            Expanded(
                              child: Builder(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'MENU_POST_PROPIO_Container_cy7h8u1g_ON_T');
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (dialogContext) {
                                        return Dialog(
                                          ...
                                          child: WebViewAware(
                                            child: AlertaEliminarPostWidget(
                                              refUserPost:
