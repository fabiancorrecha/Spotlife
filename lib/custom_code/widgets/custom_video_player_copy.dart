...
class CustomVideoPlayerCopy extends StatefulWidget {
  const CustomVideoPlayerCopy({
    super.key,
    this.width,
    this.height,
  ...
  @override
  _CustomVideoPlayerCopyState createState() => _CustomVideoPlayerCopyState();
}

class _CustomVideoPlayerCopyState extends State<CustomVideoPlayerCopy> {
